...
class ChessonlinefemaleSpider(scrapy.Spider):
    """
    Spider to retrieve the profile URLs of Female players
    """

    name = "chessonlinefemale"
    allowed_domains = ["chess.com"]
    start_urls = ["https://www.chess.com/ratings/women"]
